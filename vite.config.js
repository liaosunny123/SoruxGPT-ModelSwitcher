...
export default defineConfig({
  plugins: [
    ...
    monkey({
      ...
      userscript: {
        name: {
          '': 'SoruxGPT Model Switcher',
          'zh-CN': 'SoruxGPT 模型切换器',
          'zh-TW': 'SoruxGPT 模型切换器'
        },
        namespace: 'https://github.com/liaosunny123/SoruxGPT-ModelSwitcher',
        copyright: '2023, Hydrotho (https://github.com/liaosunny123)',
        version: '2.0.2',
        description: {
          ...
          'zh-CN':
            '在 SoruxGPT 网页端使用 GPT-4 Mobile 模型。同时，它还提供了切换到其他模型的功能，以提供更大的灵活性。一般来说，该脚本不会与其他流行的 ChatGPT 脚本产生冲突。',
          'zh-TW':
            '在 SoruxGPT 网页端使用 GPT-4 Mobile 模型。同时，它还提供了切换到其他模型的功能，以提供更大的灵活性。一般来说，该脚本不会与其他流行的 ChatGPT 脚本产生冲突。'
        },
        icon: (() => {
